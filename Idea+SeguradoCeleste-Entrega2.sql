...
CREATE TABLE IF NOT EXISTS Productos (
    ...
    ALTER TABLE productos DROP COLUMN size;
...
CREATE TABLE IF NOT EXISTS Envios (
	...
	ALTER TABLE envios DROP COLUMN estado_de_envio;
...
SELECT * FROM  productos;
 ...
 INSERT INTO ventas (id_venta, id_cliente, edad, genero, nombre_producto, categoria, size, monto_gastado, id_estado, temporada, estado_suscripcion, id_metodo, uso_promocion, id_envio, estado_del_envio, compras_anteriores) VALUES
(1, 1, 28, 'Masculino', 'Remera_termica', 'Ropa', 'L', 53, 2, 'Invierno', 1, 4, 'Si', 2, 'Enviado', 5),
(2, 2, 35, 'Femenino', 'Gorro_lana', 'Accesorios', 'S', 20, 4, 'Invierno', 0, 3, 'No', 4, 'Retirado', 2),
(3, 3, 42, 'No binario', 'Bermuda', 'Ropa', 'L', 65, 3, 'Primavera', 1, 2, 'Si', 2, 'Pendiente', 12),
(4, 4, 23, 'Femenino', 'Zapatillas_sport', 'Calzado', 'M', 49, 1, 'Verano', 1, 4, 'Si', 1, 'Enviado', 8),
(5, 5, 51, 'Masculino', 'Campera', 'Ropa', 'XL', 85, 2, 'Invierno', 0, 2, 'No', 4, 'Retirado', 0),
(6, 6, 60, 'Masculino', 'Guantes_termicos', 'Accesorios', 'M', 24, 2, 'Invierno', 1, 5, 'No', 1, 'Enviado', 25),
(7, 7, 19, 'Femenino', 'Remera_termica', 'Ropa', 'M', 35, 4, 'Otoño', 0, 5, 'Si', 2, 'Pendiente', 1),
(8, 8, 33, 'Femenino', 'Pantalon', 'Ropa', 'M', 75, 4, 'Verano', 1, 3, 'No', 3, 'Enviado', 6),
(9, 9, 48, 'Masculino', 'Pantalon', 'Ropa', 'XL', 90, 3, 'Verano', 1, 3, 'No', 3, 'Pendiente', 15),
(10, 10, 29, 'No binario', 'Zapatillas_trek', 'Calzado', 'L', 60, 4, 'Invierno', 0, 2, 'No', 3, 'Devolucion', 3),
(11, 11, 38, 'Femenino', 'Campera', 'Ropa', 'M', 55, 2, 'Otoño', 1, 2, 'Si', 1, 'Enviado', 9),
(12, 12, 55, 'Masculino', 'Gorra_visera', 'Accesorios', 'M', 30, 1, 'Verano', 0, 1, 'No', 4, 'Retirado', 2),
(13, 13, 27, 'Masculino', 'Pantalon', 'Ropa', 'L', 75, 2, 'Verano', 1, 2, 'Si', 3, 'Pendiente', 7),
(14, 14, 45, 'Femenino', 'Medias_soft', 'Accesorios', 'S', 15, 2, 'Invierno', 1, 1, 'Si', 4, 'Retirado', 18),
(15, 15, 21, 'No binario', 'Remera_termica', 'Ropa', 'L', 30, 4, 'Otoño', 0, 2, 'No', 1, 'Enviado', 4);
...
SELECT genero, COUNT(id_venta) AS cantidad_ventas,
...
DELIMITER //
CREATE FUNCTION Totalvendido (p_totalventas DECIMAL(10,2))
...
SELECT Totalvendido(monto_gastado) AS Total_ventas
FROM ventas;

-- Función para calcular el promedio de gasto de las ventas --
DELIMITER //
CREATE FUNCTION promedio_gastado (p_promedioventa DECIMAL(10,2))
RETURNS DECIMAL(10,2)
DETERMINISTIC
BEGIN
...
SELECT promedio_gastado(monto_gastado) AS Promedio_de_gasto
FROM ventas;
...
SET SQL_SAFE_UPDATES = 0;   
INSERT INTO ventas (id_venta, id_cliente, edad, genero, nombre_producto, categoria, size, monto_gastado, id_estado, temporada, estado_suscripcion, id_metodo, uso_promocion, id_envio, estado_del_envio, compras_anteriores) VALUES
(16, 14, 45, 'Femenino', 'Campera', 'Ropa', 'M', 75, 4, 'Otoño', 1, 3, 'No', 3, 'Enviado', 18);
...
INSERT INTO clientes_fidelizados(id_cliente_fiel, id_cliente, genero, edad, mail, compras_anteriores) VALUES
(1, 1, 'Masculino', 28, 'lucasrodriguez1@gmail.com', 5),
(2, 3, 'No binario', 42, 'elif343@gmail.com', 12),
(3, 4, 'Femenino', 23, 'vaneortiz43@hotmail.com', 8),
(4, 6, 'Masculino', 60, 'hgmendez@gmail.com', 25),
(5, 8, 'Femenino', 33, 'kprieto222@gmail.com', 6),
(6, 9, 'Masculino', 48, 'gimenez.seba@gmail.com', 15),
(7, 11, 'Femenino', 38, 'latanalorenzo@gmail.com', 9),
(8, 13, 'Masculino', 27, 'gilettalorenzo@gmail.com', 7),
(9, 14, 'Femenino', 45, 'segurado.celes@gmail.com', 18);
...
BEGIN
    ...
    INSERT INTO clientes_fidelizados (id_cliente) VALUES (NEW.id_cliente)
        ON DUPLICATE KEY UPDATE id_cliente = NEW.id_cliente;
    END IF;
END//
DELIMITER ; 
...
SET compras_anteriores = 5
WHERE id_cliente = 15; -- arroja Error Code: 1193. Unknown system variable 'compras_anteriores' - no entiendo el error aquí y no logro solucionarlo --
